...
video = cv2.VideoCapture("/home/pdhqferreira/Python/PRO_1-1_C107_TemplateProjeto-main/footvolleyball.mp4")
...
while True:
   ...
   if success:
    ...
    cv2.putText(img,"errou",(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,0,255),2)
   goal_track(img,bbox)
